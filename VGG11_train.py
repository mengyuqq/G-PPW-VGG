...
from vgg11_k_CBA import vgg

if os.path.exists("result/12_vgg11_k_CBA_lr_0.0005") is False:
    os.makedirs("result/12_vgg11_k_CBA_lr_0.0005")
path = "result/12_vgg11_k_CBA_lr_0.0005/"
...
# plt.show()
# model_name = "vgg11"
# model = vgg(model_name=model_name, num_classes=6, init_weights=True)
model = vgg(6)
model.to(device)
print(model)
