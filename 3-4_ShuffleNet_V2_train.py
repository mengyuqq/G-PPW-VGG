...
from shufflenet import shufflenet_v2_x1_5

if os.path.exists("result/7_shufflenet_v2_x1_5") is False:
    os.makedirs("result/7_shufflenet_v2_x1_5")
path = "result/7_shufflenet_v2_x1_5/"
